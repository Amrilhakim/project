...
<br/>
	<div class="login-01">
			<form method="post" id="theform" action="today.php">
				<ul>
				<li class="first">
					<input type="text" name="tgl" class="text"  >
					<div class="clear"></div>
				</li>
			    </ul>
...
<table id='tfhover' class='tftable' border='1' align='center'> <col width='50'><col width='110'><col width='110'><col width='110'><col width='110'><col width='200'><col width='200'><col width='200'><col width='50'> 
<tr>
<th >No. Resi</th>
<th >Pengirim</th>
<th >Telp</th>
...
include "../koneksi.php"; 
				...
				$select = "select * from data where waktukirim >= 'S_POST[tgl]';
